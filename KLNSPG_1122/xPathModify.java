...
public class xPathModify {
    ...
    public static void main(String[] args) {
        try {
            ...
            File inputFile = new File("KLNSPG_1122\\KLNSPG_kurzusfelvetel.xml");
    ...
    private static void addNewCourse(Document doc, XPath xPath) throws XPathExpressionException {
        Element kurzusokElement = (Element) xPath.compile("/KLNSPG_kurzusfelvetel/kurzusok").evaluate(doc, XPathConstants.NODE);
    ...
    private static void deleteCourse(Document doc, XPath xPath) throws XPathExpressionException {
        Node courseToDelete = (Node) xPath.compile("/KLNSPG_kurzusfelvetel/kurzusok/kurzus[@id='GEIAL120-B']").evaluate(doc, XPathConstants.NODE);
    ...
    private static void modifyCourse(Document doc, XPath xPath) throws XPathExpressionException {
        Node courseToModify = (Node) xPath.compile("/KLNSPG_kurzusfelvetel/kurzusok/kurzus[@id='GEMAK234-B']").evaluate(doc, XPathConstants.NODE);
